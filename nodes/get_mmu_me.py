...
SPEC = CONSTANTS['mmu_me']


def get_mmu_me(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """muon-to-electron mass ratio: 206.768 ± 4.6e-06 dimensionless (derived, established). Returns the full spec."""
    m = ConstantSpec(
