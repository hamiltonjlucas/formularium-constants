...
SPEC = CONSTANTS['beta0_QCD']


def get_beta0_qcd(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """QCD one-loop beta coefficient (nf=3): 9 ± 0 dimensionless (definition, established). Returns the full spec."""
    m = ConstantSpec(
