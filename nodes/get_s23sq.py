...
SPEC = CONSTANTS['s23sq']


def get_s23sq(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """neutrino sin^2(theta23): 0.451 ± 0.019 dimensionless (NuFIT, established). Returns the full spec."""
    m = ConstantSpec(
