...
SPEC = CONSTANTS['Delta_m21_sq']


def get_delta_m21_sq(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """solar mass-squared splitting: 7.41e-05 ± 2.1e-06 eV^2 (NuFIT, established). Returns the full spec."""
    m = ConstantSpec(
