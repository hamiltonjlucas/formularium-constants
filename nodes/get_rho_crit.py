...
SPEC = CONSTANTS['rho_crit']


def get_rho_crit(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """critical density of the universe: 8.53e-27 kg/m^3 (derived, established). Returns the full spec."""
    m = ConstantSpec(
