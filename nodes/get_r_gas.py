...
SPEC = CONSTANTS['R_gas']


def get_r_gas(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """molar gas constant: 8.31446 J/(mol*K) (derived, established). Returns the full spec."""
    m = ConstantSpec(
