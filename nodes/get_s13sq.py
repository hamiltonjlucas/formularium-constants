...
SPEC = CONSTANTS['s13sq']


def get_s13sq(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """neutrino sin^2(theta13): 0.02225 ± 0.00059 dimensionless (NuFIT, established). Returns the full spec."""
    m = ConstantSpec(
