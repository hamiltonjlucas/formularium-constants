...
SPEC = CONSTANTS['sigma_SB']


def get_sigma_sb(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """Stefan-Boltzmann constant: 5.67037e-08 W/(m^2*K^4) (derived, established). Returns the full spec."""
    m = ConstantSpec(
