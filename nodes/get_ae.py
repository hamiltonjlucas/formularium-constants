...
def get_ae(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """electron anomalous magnetic moment: 0.00115965 ± 1.3e-12 dimensionless (derived, established). Returns the full spec."""
    m = ConstantSpec(
