...
SPEC = CONSTANTS['mp_me']


def get_mp_me(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """proton-to-electron mass ratio: 1836.15 ± 3.2e-08 dimensionless (derived, established). Returns the full spec."""
    m = ConstantSpec(
