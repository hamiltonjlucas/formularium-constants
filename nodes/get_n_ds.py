...
def get_n_ds(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """de Sitter horizon capacity: 3.309e+122 ± 6e+120 dimensionless (derived, established). Returns the full spec."""
    m = ConstantSpec(
