...
SPEC = CONSTANTS['Omega_Lambda']


def get_omega_lambda(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """dark-energy density parameter: 0.6847 ± 0.0073 dimensionless (Planck, established). Returns the full spec."""
    m = ConstantSpec(
