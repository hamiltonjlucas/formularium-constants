...
SPEC = CONSTANTS['b_wien']


def get_b_wien(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """Wien displacement-law constant: 0.00289777 m*K (derived, established). Returns the full spec."""
    m = ConstantSpec(
