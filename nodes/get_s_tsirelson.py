...
SPEC = CONSTANTS['S_Tsirelson']


def get_s_tsirelson(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """Tsirelson bound: 2.82843 dimensionless (derived, established). Returns the full spec."""
    m = ConstantSpec(
