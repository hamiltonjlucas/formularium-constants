...
SPEC = CONSTANTS['kappa_cap']


def get_kappa_cap(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """holographic capacity density: 9.5702e+68 ± 2.2e+64 m^-2 (derived, established). Returns the full spec."""
    m = ConstantSpec(
