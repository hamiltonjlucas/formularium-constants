...
SPEC = CONSTANTS['R_inf']


def get_r_inf(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """Rydberg constant: 1.09737e+07 ± 1.2e-05 m^-1 (CODATA, established). Returns the full spec."""
    m = ConstantSpec(
