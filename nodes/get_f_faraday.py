...
SPEC = CONSTANTS['F_faraday']


def get_f_faraday(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """Faraday constant: 96485.3 C/mol (derived, established). Returns the full spec."""
    m = ConstantSpec(
