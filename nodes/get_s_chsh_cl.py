...
SPEC = CONSTANTS['S_CHSH_cl']


def get_s_chsh_cl(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """CHSH classical bound: 2 dimensionless (derived, established). Returns the full spec."""
    m = ConstantSpec(
