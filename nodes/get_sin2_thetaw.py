...
SPEC = CONSTANTS['sin2_thetaW']


def get_sin2_thetaw(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """weak mixing angle: 0.23122 ± 4e-05 dimensionless (PDG, established). Returns the full spec."""
    m = ConstantSpec(
