...
SPEC = CONSTANTS['sigma_T']


def get_sigma_t(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """Thomson cross section: 6.65246e-29 ± 6.2e-38 m^2 (CODATA, established). Returns the full spec."""
    m = ConstantSpec(
