...
def get_gn(ax: AxiomContext, input: Empty) -> ConstantSpec:
    """Newtonian gravitational constant: 6.6743e-11 ± 1.5e-15 m^3/(kg*s^2) (CODATA, established). Returns the full spec."""
    m = ConstantSpec(
